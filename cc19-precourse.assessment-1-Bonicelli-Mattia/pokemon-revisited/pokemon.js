(() => {
  window.allPokemon = [
    ...
    },
    {
      ...
      "Base Flee Rate": "9% chance to flee.",
      "Common Capture Area":
        "Early reports that this Pokèmon is likely to be found in: Asia or hatched from an Egg in that geographic area.",
    ...
    },
    {
      ...
      "Base Flee Rate": "9% chance to flee.",
      "Common Capture Area":
        "Early reports that this Pokèmon is likely to be found in: Australia, New Zealand or hatched from an Egg in that geographic area.",
    ...
    },
    {
      ...
      "Base Flee Rate": "9% chance to flee.",
      "Common Capture Area":
        "Early reports that this Pokèmon is likely to be found in: Western Europe or hatched from an Egg in that geographic area.",
    ...
    },
    {
      ...
      "Base Flee Rate": "9% chance to flee.",
      "Common Capture Area":
        "Early reports that this Pokèmon is likely to be found in: North America or hatched from an Egg in that geographic area.",
    ...
    },
    {
      ...
      Types: ["Fairy", "Flying"],
      Resistant: ["Grass", "Fighting", "Ground", "Bug", "Dragon", "Dark"],
    ...
    },
    {
      ...
      Types: ["Water", "Fairy"],
      Resistant: ["Fire", "Water", "Ice", "Fighting", "Bug", "Dragon", "Dark"],
    ...
    },
    {
      ...
      Types: ["Fire", "Rock"],
      Resistant: ["Normal", "Fire", "Ice", "Poison", "Flying", "Bug", "Fairy"],
    ...
    },
    {
      ...
      Types: ["Dark", "Fire"],
      Resistant: ["Fire", "Grass", "Ice", "Psychic", "Ghost", "Dark", "Steel"],
      Weaknesses: ["Water", "Fighting", "Ground", "Rock"],
      "Fast Attack(s)": [
        {
          Name: "Tackle",
