...
describe("Trees", () => {
  ...
  describe("The remove method", () => {
    ...
    it("should correctly detect nested children", () => {
      ...
      tree.addChild(2);
      tree.addChild(3);
      const targetNode = tree.addChild(4);
      tree.children[0].addChild(5);
      tree.children[1].addChild(4);
      // Execution
      const removedNode = tree.remove(4);
      // Assert
      expect(removedNode).to.deep.equal(targetNode);

      expect(tree.remove(27)).to.equal(undefined);
    });

    it("should correctly detect deeply nested children", () => {
      // Setup
      tree.addChild(2);
      tree.addChild(3);
      tree.addChild(4);
      const targetNode = tree.children[0].addChild(5);
      tree.children[1].addChild(4);
      // Execution
